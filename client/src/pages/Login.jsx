        ...
        <div className={`min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden transition-colors duration-200 ${
            ...
            <div className={`w-full max-w-4xl backdrop-blur-xl border rounded-3xl shadow-2xl overflow-hidden grid md:grid-cols-12 relative z-10 ${
                ...
                <div className="md:col-span-7 p-8 sm:p-10 flex flex-col justify-center">
                    <div className="mb-5">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[11px] font-bold uppercase tracking-wider mb-2">
                            <Sparkles size={12} />
                            Portal Access
                        </div>
                    ...
                    <div className="mb-5 p-3.5 bg-slate-950/70 border border-slate-800 rounded-2xl">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button
                                ...
                                className="p-2.5 rounded-xl bg-blue-950/50 hover:bg-blue-900/60 border border-blue-800/40 text-left transition group"
                            >
                                <p className="text-xs font-bold text-blue-300 flex items-center gap-1">
                                    <User size={12} />
                                    <span>Shubham (Candidate)</span>
                                </p>
                                <p className="text-[10px] text-slate-400 mt-0.5">Grade A+ • 92% Readiness</p>
                            </button>

                            <button
                                type="button"
                                onClick={() => handleQuickLogin("sarah.google@google.com", "recruiter")}
                                className="p-2.5 rounded-xl bg-indigo-950/50 hover:bg-indigo-900/60 border border-indigo-800/40 text-left transition group"
                            >
                                <p className="text-xs font-bold text-indigo-300 flex items-center gap-1">
                                    <Building2 size={12} />
                                    <span>Sarah (Google Recruiter)</span>
                                </p>
                                <p className="text-[10px] text-slate-400 mt-0.5">Google Staff Recruiter</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="relative mb-5">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase font-bold text-slate-500">
                            <span className="bg-slate-900/90 px-3">Or enter email & password</span>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-800/80 border border-slate-700 rounded-xl pl-10 pr-4 py-3 text-xs sm:text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-800/80 border border-slate-700 rounded-xl pl-10 pr-10 py-3 text-xs sm:text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition"
                                />
                                <button
                                    type="button"
